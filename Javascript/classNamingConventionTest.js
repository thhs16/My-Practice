// error due to naming convertion; 3D1 class is started with number
...
function checking(){
          ...
          for(let i=2; i<clas; i++){
                    let check3Dst = document.querySelector('.3D1');
                    // let check3Dst = document.getElementsByName(`D3${i-1}`);
                    // let check3Dst = document.querySelector('input[name="`D31`"]');

                    let check3Dnd = document.querySelector('.3D2');
